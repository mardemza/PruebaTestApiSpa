...
{
    [DbContext(typeof(PruebaApiSpaDbContext))]
    [Migration("20200807034851_AddCountryProvince")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PruebaApiSpa.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PruebaApiSpa.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PruebaApiSpa.Domain.Country", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PruebaApiSpa.Domain.Province", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PruebaApiSpa.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("PruebaApiSpa.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("PruebaApiSpa.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("PruebaApiSpa.Authorization.Roles.Role", b =>
                {
                    b.HasOne("PruebaApiSpa.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("PruebaApiSpa.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("PruebaApiSpa.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("PruebaApiSpa.Domain.Province", b =>
                {
                    b.HasOne("PruebaApiSpa.Domain.Country", "Country")
                        .WithMany("Provinces")
