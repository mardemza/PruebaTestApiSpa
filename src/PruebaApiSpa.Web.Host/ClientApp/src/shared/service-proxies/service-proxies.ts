...
export class CountryServiceProxy {
     ...
     * @return Success
     */
    addOrUpdate(body: CountryInputDto | undefined): Observable<CountryDto> {
        let url_ = this.baseUrl + "/api/services/app/Country/AddOrUpdate";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processAddOrUpdate(response: HttpResponseBase): Observable<CountryDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<CountryInputDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CountryInputDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CountryInputDto>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<CountryInputDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CountryInputDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CountryInputDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(body: SearchDto | undefined): Observable<CountryDtoContextDto> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CountryDtoContextDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CountryDtoContextDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<CountryDtoContextDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CountryDtoContextDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CountryDtoContextDto>(<any>null);
    }
}
...
export class CountryInputDto implements ICountryInputDto {
    ...
    linkSubDivision: string | undefined;
    id: number;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.numericCode = _data["numericCode"];
            this.linkSubDivision = _data["linkSubDivision"];
            this.id = _data["id"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["linkSubDivision"] = this.linkSubDivision;
        data["id"] = this.id;
        return data; 
    }

    clone(): CountryInputDto {
        const json = this.toJSON();
        let result = new CountryInputDto();
        result.init(json);
        return result;
...
export class CountryDto implements ICountryDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.alpha2Code = _data["alpha2Code"];
            this.linkSubDivision = _data["linkSubDivision"];
            this.provincesCount = _data["provincesCount"];
            this.id = _data["id"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["alpha2Code"] = this.alpha2Code;
        data["linkSubDivision"] = this.linkSubDivision;
        data["provincesCount"] = this.provincesCount;
        data["id"] = this.id;
        return data; 
    }
...
export class CountryDtoContextDto implements ICountryDtoContextDto {
    data: CountryDto[] | undefined;
    metaData: IPagedList;

    constructor(data?: ICountryDtoContextDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CountryDtoContextDto {
        data = typeof data === 'object' ? data : {};
        let result = new CountryDtoContextDto();
        result.init(data);
        return result;
    }
...
export interface ICountryDtoContextDto {
    data: CountryDto[] | undefined;
    metaData: IPagedList;
}
